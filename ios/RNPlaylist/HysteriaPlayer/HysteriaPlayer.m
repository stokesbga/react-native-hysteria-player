...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object
    ...
    if (object == self.audioPlayer.currentItem && [keyPath isEqualToString:@"status"]) {
        ...
        if (self.audioPlayer.currentItem.status == AVPlayerItemStatusFailed) {
            NSLog(@"HysteriaPlayer: BbbbBBBBBBBBB");
            NSLog(@"HysteriaPlayer: BbbbBBBBBBBBB");
            if ([self.delegate respondsToSelector:@selector(hysteriaPlayerTrackDidFailAtIndex:error:)]) {
                NSLog(@"HysteriaPlayer: OOGAGOOGOOGOAGOOG");
                NSLog(@"HysteriaPlayer: OOGAGOOGOOGOAGOOG");
                NSNumber *currentItemIndex = [self getHysteriaIndex:self.audioPlayer.currentItem];
                [self.delegate hysteriaPlayerTrackDidFailAtIndex:currentItemIndex error:self.audioPlayer.currentItem.error];
            }
